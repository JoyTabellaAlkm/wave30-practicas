...
public class Main {
    public static void main(String[] args) {
        ...
        //Recorro la lista con for clasico
        for (int i = 0; i < listaInt.size(); i++) {
            System.out.println("Con for clasico: " + listaInt.get(i));
        }
        //Recorro la lista con for nuevo
        for (Integer i : listaInt) {
            System.out.println("Con for nuevo: " + i);
        }
